layui.define(['layer', 'form', 'laytpl'], function (exports) {
    ...
    Class.prototype.events = function () {
     ...
     // console.log('监听省变化1111'+JSON.stringify(data))
        //let code = getCode('province', data.value);
          // console.log('监听省变化222'+JSON.stringify(code))
      ...
      function renderProvince(){
        ...
        //console.log('当前111111111'+JSON.stringify(currentCode))
        //  console.log('当前2222222222222'+JSON.stringify(currentName))
        options.data.province = currentName;
        provinceEl.html(tpl);
        provinceEl.val(currentCode);
        form.render('select');
